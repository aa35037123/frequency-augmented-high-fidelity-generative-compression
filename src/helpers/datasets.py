...
DATASETS_DICT = {"openimages": "OpenImages", "cityscapes": "CityScapes", 
                 "jetimages": "JetImages", "evaluation": "Evaluation", 'kodak':'Kodak'}
...
class Kodak(BaseDataset):
    ...
    """
    files = {"train": "train", "test": "test", "val": "validation", 'eval':'evaluation'}

    def __init__(self, root=os.path.join(DIR, 'data/Kodak'), mode='train', crop_size=256, 
