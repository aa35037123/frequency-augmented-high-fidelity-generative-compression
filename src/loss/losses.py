...
def _non_saturating_loss(D_real_logits, D_gen_logits, D_real=None, D_gen=None):
    ...
    # compare discriminator and whole 1, this is used to let D's output can close 1  
    ...
    # print(D_gen_logits.shape)
    # print(torch.mean(D_gen_logits))
    # goal of G is generate output that is classified 1 by D 
    # 0: gen output, 1: real output
...
def _least_squares_loss(D_real, D_gen, D_real_logits=None, D_gen_logits=None):
    ...
    print(D_loss_gen, 'aaaaaaaaaaaaa')
