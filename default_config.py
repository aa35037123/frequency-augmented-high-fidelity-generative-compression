...
class DatasetPaths(object):
    OPENIMAGES = 'data/openimages/crowdsource_images/'
    CITYSCAPES = ''
    JETS = ''
    KODAK = 'data/Kodak/PhotoCD_PCD0992/'
...
class args(object):
    ...
    k_ffl = 0.5                     # Focal Frequancy Loss
    k_dsl = 0.25                    # Dynamic Spectrum Loss for feature domain
    ...
    latent_channels_DLMM = 64 # distributed linear mixed models
